...
import { PERMISSIONS } from '@karzintell/shared';
...
export class RbacService {
  ...
  async createRole(name: string, title: string, permissions: string[]) {
  ...
  async updateRole(id: number, dto: { title?: string; description?: string; permissions?: string[] }) {
