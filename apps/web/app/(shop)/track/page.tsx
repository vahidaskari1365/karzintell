...
export default function TrackPage() {
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      ...
      <p className="mb-6 text-sm text-slate-500">کد سفارش و شماره موبایل تحویل‌گیرنده را وارد کنید.</p>
      ...
      {result && (
        <Card className="mt-6 space-y-3">
          ...
          <div className="text-sm text-slate-500">ثبت: {faDateTime(result.createdAt)}</div>
          <div className="border-t border-slate-100 pt-3 text-sm font-bold">
