...
export const tableCls = {
  wrap: 'overflow-x-auto rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900/40',
  table: 'w-full min-w-[640px] text-sm',
  thead: 'bg-slate-50 text-xs text-slate-500 dark:bg-slate-900/80 dark:text-slate-400',
  th: 'px-4 py-3 text-start font-bold',
  td: 'px-4 py-3 text-slate-700 dark:text-slate-300',
  row: 'border-t border-slate-100 hover:bg-slate-50/60 dark:border-slate-800 dark:hover:bg-slate-800/40 transition',
};
...
const STATUS_TONES: Record<string, string> = {
  ...
  archived: 'bg-slate-200 text-slate-500 dark:bg-slate-500/20 dark:text-slate-400',
  ...
  closed: 'bg-slate-100 text-slate-500 dark:bg-slate-500/20 dark:text-slate-400',
  ...
  refunded: 'bg-slate-200 text-slate-500 dark:bg-slate-500/20 dark:text-slate-400',
};

export function Pill({ status, label }: { status: string; label: string }) {
  return (
    <span className={`inline-block rounded-full px-2.5 py-1 text-2xs font-bold ${STATUS_TONES[status] || 'bg-slate-100 text-slate-600 dark:bg-slate-500/20 dark:text-slate-300'}`}>
      {label}
    </span>
  );
}
