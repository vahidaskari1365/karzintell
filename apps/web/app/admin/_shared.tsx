...
export const tableCls = {
  ...
  thead: 'bg-slate-50 text-xs text-slate-500 dark:bg-slate-100 dark:bg-slate-900/80 dark:text-slate-600 dark:text-slate-400',
  ...
  return (
    <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
      <div>
        ...
        {subtitle && <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-600 dark:text-slate-400">{subtitle}</p>}
      </div>
      {action}
    </div>
  );
...
const STATUS_TONES: Record<string, string> = {
  ...
  archived: 'bg-slate-200 text-slate-500 dark:bg-slate-500/20 dark:text-slate-600 dark:text-slate-400',
  ...
  closed: 'bg-slate-100 text-slate-500 dark:bg-slate-500/20 dark:text-slate-600 dark:text-slate-400',
  ...
  refunded: 'bg-slate-200 text-slate-500 dark:bg-slate-500/20 dark:text-slate-600 dark:text-slate-400',
};
