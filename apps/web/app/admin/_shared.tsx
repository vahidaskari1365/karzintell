...
export const tableCls = {
  ...
  thead: 'bg-slate-50 text-xs text-slate-500 dark:bg-slate-100 dark:bg-slate-900/80 dark:text-slate-600 dark:text-slate-300',
  th: 'px-4 py-3 text-start font-bold',
  td: 'px-4 py-3 text-slate-700 dark:text-slate-700 dark:text-slate-300',
  ...
  return (
    <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
      <div>
        ...
        {subtitle && <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-600 dark:text-slate-300">{subtitle}</p>}
      </div>
      {action}
    </div>
  );
...
const STATUS_TONES: Record<string, string> = {
  ...
  draft: 'bg-slate-100 text-slate-600 dark:bg-slate-500/20 dark:text-slate-700 dark:text-slate-300',
  pending: 'bg-amber-50 text-amber-700 dark:bg-amber-500/20 dark:text-amber-300',
  archived: 'bg-slate-200 text-slate-500 dark:bg-slate-500/20 dark:text-slate-600 dark:text-slate-300',
  ...
  closed: 'bg-slate-100 text-slate-500 dark:bg-slate-500/20 dark:text-slate-600 dark:text-slate-300',
  ...
  refunded: 'bg-slate-200 text-slate-500 dark:bg-slate-500/20 dark:text-slate-600 dark:text-slate-300',
};

export function Pill({ status, label }: { status: string; label: string }) {
  return (
    <span className={`inline-block rounded-full px-2.5 py-1 text-2xs font-bold ${STATUS_TONES[status] || 'bg-slate-100 text-slate-600 dark:bg-slate-500/20 dark:text-slate-700 dark:text-slate-300'}`}>
      {label}
    </span>
  );
}
