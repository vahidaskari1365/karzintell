            ...
            <tbody>
              {(items || []).map((b) => (
                <tr key={b.id} className={tableCls.row}>
                  ...
                  <td className={tableCls.td}><code className="text-xs text-slate-600 dark:text-slate-300" dir="ltr">{b.slug}</code></td>
                  ...
                  <td className={`${tableCls.td} text-left`}>
                    <div className="flex justify-end gap-1">
                      ...
                      <button onClick={() => setDeleting(b)} className="rounded-lg p-2 text-slate-600 dark:text-slate-300 hover:bg-rose-50 hover:text-rose-600">
