                ...
                {items.map((c) => (
                  <tr key={c.id} className={tableCls.row}>
                    ...
                    <td className={tableCls.td}>
                      ...
                      {c.email && <p className="text-2xs text-slate-600 dark:text-slate-200" dir="ltr">{c.email}</p>}
                    </td>
                    <td className={tableCls.td}>{faNumber(c.ordersCount ?? 0)}</td>
                    <td className={tableCls.td}>{c.totalSpent != null ? toToman(c.totalSpent) : '—'}</td>
                    <td className={tableCls.td}><span className="text-xs text-slate-600 dark:text-slate-200">{faDate(c.createdAt)}</span></td>
