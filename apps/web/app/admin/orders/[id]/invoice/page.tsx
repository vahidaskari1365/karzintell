...
export default function AdminOrderInvoicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="py-6">
      <Link href={`/admin/orders/${id}`} className="mb-4 inline-flex items-center gap-1.5 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200 print:hidden">
